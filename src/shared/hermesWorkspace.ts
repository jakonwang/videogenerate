...
export const HERMES_WORKSPACES: readonly HermesWorkspaceDefinition[] = [
  ...
  { id: 'inventory-analysis', name: 'Dianxiaomi inventory analytics', description: 'Track SKU stock, shipped quantities, and reorder forecasts.', routeName: 'plugin-dianxiaomi-inventory' },
