...
assert.equal(LIVE_PHOTO_IMAGE_RETRY_LIMIT, 10)
assert.equal(resolveLivePhotoRetryLimit('image_generation'), 10)
assert.equal(resolveLivePhotoRetryLimit('image_validation'), 10)
